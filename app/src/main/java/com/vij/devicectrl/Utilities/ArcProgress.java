...
public class ArcProgress extends View {
    ...
    private final int default_finished_color = Color.parseColor("#4DB6AC");
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = FontUtils.sp2px(getResources(), 18);
        min_size = (int) FontUtils.dp2px(getResources(), 100);
        default_text_size = FontUtils.sp2px(getResources(), 40);
        default_suffix_text_size = FontUtils.sp2px(getResources(), 15);
        default_suffix_padding = FontUtils.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = FontUtils.sp2px(getResources(), 12);
        default_stroke_width = FontUtils.dp2px(getResources(), 4);
